<?php
    ...
    require_once($CFG->dirroot.'/blocks/viewsblock/lib.php');
    ...
    $id       = required_param('viewsgraphid', PARAM_INT);
    ...
    $context = block_viewsblock_course_context($courseid);
    ...
    $PAGE->set_url(
        '/blocks/viewsblock/overview.php',
        array(
            'viewsgraphid' => $id,
            'courseid' => $courseid,
            'page' => $page,
